...
if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite-r2")
    message(FATAL_ERROR
        "apollo2_evb requires NSX_SDK_PROVIDER=ambiqsuite-r2, got '${NSX_SDK_PROVIDER}'."
    )
endif()
...
set(NSX_BOARD_TARGET_EXPORT_NAME "board_apollo2_evb")
set(NSX_BOARD_FLAGS_TARGET_EXPORT_NAME "board_flags_apollo2_evb")
...
add_library(nsx::board_apollo2_evb ALIAS ${NSX_BOARD_TARGET})
