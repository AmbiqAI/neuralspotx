...
Reset_Handler(void)
{
    ...
    //
    // Copy the shared-SRAM data segment initializers from flash to SRAM
    // (.shared — NSX_MEM_SRAM placements).
    //
    ...
    //
    // Zero fill the shared-SRAM BSS region (.sram_bss — NSX_MEM_SRAM_BSS).
    //
