...
if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite-r3")
    message(FATAL_ERROR
        "apollo3p_evb requires NSX_SDK_PROVIDER=ambiqsuite-r3, got '${NSX_SDK_PROVIDER}'."
    )
endif()
...
set(NSX_BOARD_FLAGS_TARGET nsx_board_apollo3p_evb_flags)
set(NSX_SOC_TARGET_EXPORT_NAME "soc_hal_apollo3p")
set(NSX_STARTUP_TARGET_EXPORT_NAME "startup_apollo3p")
set(NSX_BOARD_TARGET_EXPORT_NAME "board_apollo3p_evb")
set(NSX_BOARD_FLAGS_TARGET_EXPORT_NAME "board_flags_apollo3p_evb")
...
add_library(nsx::board_apollo3p_evb ALIAS ${NSX_BOARD_TARGET})
