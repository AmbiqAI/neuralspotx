...
nsx_load_soc_facts("apollo510")

if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite-r5")
    message(FATAL_ERROR
        "apollo510_evb requires NSX_SDK_PROVIDER=ambiqsuite-r5, got '${NSX_SDK_PROVIDER}'."
    )
endif()

set(NSX_AMBIQ_BOARD_NAME "apollo510_evb")
set(NSX_AMBIQ_PART_NAME "apollo510")
set(NSX_AMBIQ_BSP_LIB_SUBDIR "apollo510_evb")
...
if(NSX_TOOLCHAIN_FAMILY STREQUAL "armclang")
    ...
    set(NSX_LINKER_SCRIPT "${NSX_CORE_DIR}/src/apollo510/armclang/linker_script_sbl.sct")
else()
    set(NSX_STARTUP_SOURCE "${NSX_CORE_DIR}/src/apollo510/gcc/startup_gcc.c")
    set(NSX_SYSTEM_SOURCE "${NSX_AMBIQSUITE_ROOT}/CMSIS/AmbiqMicro/Source/system_apollo510.c")
    set(NSX_LINKER_SCRIPT "${NSX_CORE_DIR}/src/apollo510/gcc/linker_script_sbl.ld")
endif()
