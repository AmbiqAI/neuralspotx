...
| `helia-dsp` | NSX-packaged helia-dsp fork of CMSIS-DSP, preserving upstream Source/ CMake as the single source of truth. Distribution `v1.1.0` carries the CMSIS-DSP `1.17.x` API/payload lineage. | Signal processing, feature extraction, and FFT/filtering kernels for embedded DSP workloads. | [helia-dsp](https://github.com/AmbiqAI/helia-dsp/tree/v1.1.0) |
...
| `nsx-ethos-u-driver` | NSX integration of Arm's Ethos-U core driver, exposed as `nsx::ethos_u_driver`. | Ethos-U NPU dispatch for HeliaAOT, HeliaRT, TFLM, and bespoke C runtimes. | [nsx-ethos-u-driver](https://github.com/AmbiqAI/nsx-ethos-u-driver/tree/nsx-ethos-u-driver-v0.1.2) |
