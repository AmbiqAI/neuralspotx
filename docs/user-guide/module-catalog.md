...
| `nsx-cmsis-nn` | heliaCORE kernels and NSX integration for ML inference workloads. | Accelerated neural-network kernels for inference apps. | [ns-cmsis-nn](https://github.com/AmbiqAI/ns-cmsis-nn/tree/v7.29.1) |
