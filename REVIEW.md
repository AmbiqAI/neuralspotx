...
- [x] **R17. Board/toolchain/provider single source of truth.** Consolidate Python constants and CMake conditionals into one authoritative mapping (generated or shared). Refs: `constants.py`, `nsx_sdk_providers.cmake`, `nsx_toolchain_flags.cmake`.
